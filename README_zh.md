...
- [快速开始](#-快速开始)
  ...
  - [ClawGUI-Skills — 自进化技能](#-clawgui-skills--自进化技能)
...
| 🧩 **[ClawGUI-Skills](clawgui-skills/)** | **自进化技能** — 实现我们论文提出并验证的训练自由技能自进化架构：结构化技能包、按需检索、失败诊断、受限修订与复用 |
...
> 📁 [`clawgui-skills/`](clawgui-skills/) · 📖 [完整文档](clawgui-skills/README_zh.md) · [English](clawgui-skills/README.md)
...
→ **[查看 ClawGUI-Skills 完整文档](clawgui-skills/README_zh.md)**


### 📱 ClawGUI-APP — 真机部署

> 📁 [`clawgui-app/`](clawgui-app/) · 📖 [安装指南](clawgui-app/SETUP.md)
...
→ **[构建 ClawGUI-APP](clawgui-app/SETUP.md)**
...
- [x] **真机部署 ClawGUI-Agent（[ClawGUI-APP](clawgui-app/)）** — 将 ClawGUI-Agent 直接部署在真实手机上 —— 无需桌面端协调，为未来完全本地推理铺路（brain/VLM 当前仍通过云端 API 提供）
