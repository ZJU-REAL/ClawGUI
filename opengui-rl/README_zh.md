...
- [**verl-agent**](https://github.com/volcengine/verl) — 底层 RL 训练引擎
- [**MAI-UI**](https://github.com/sugarandgugu/MAI-UI) — GUI-Spec 模型与 GUI 动作框架
- [**MobileWorld**](https://github.com/X-PLUG/MobileWorld) — Android 模拟器环境
